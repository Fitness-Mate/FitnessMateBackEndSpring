...
public class AdminMachineController {
    ...
    @PostMapping("admin/machines") //운동기구 생성
    ...
    @DeleteMapping("admin/machines/{machineId}") //운동기구 삭제
    @PreAuthorize("hasAuthority('Admin')")
