...
//
//@Slf4j
//public class LoginAdminCheckInterceptor implements HandlerInterceptor {
//    @Override
...
//            log.info("미인증 관리자 요청!");
//            // 로그인으로 redirect
//            response.sendError(401,"미인증 관리자 요청!\n/admin/login 에 Login 요청을 보내서 loginSession 을 만들고 오세요");
//
//            // 화이트 리스트 등록을 인터셉터 등록시에 할 수 있어서 여기서 구현하지 않아도 된다.
//            return false;
//        }
//        log.info("관리자 {}님 로그인 session 확인", ((User)session.getAttribute(SessionConst.LOGIN_ADMIN)).getUserName());
//
//
//        return true;
//    }
