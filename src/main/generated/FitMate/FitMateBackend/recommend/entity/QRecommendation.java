...
public class QRecommendation extends EntityPathBase<Recommendation> {
    ...
    private static final long serialVersionUID = -17037030L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QRecommendation recommendation = new QRecommendation("recommendation");

    public final FitMate.FitMateBackend.user.entity.QBodyData bodyData;
    ...
    public QRecommendation(Class<? extends Recommendation> type, PathMetadata metadata, PathInits inits) {
        ...
        this.bodyData = inits.isInitialized("bodyData") ? new FitMate.FitMateBackend.user.entity.QBodyData(forProperty("bodyData"), inits.get("bodyData")) : null;
