...
public class QRecommendedWorkout extends EntityPathBase<RecommendedWorkout> {
    ...
    private static final long serialVersionUID = -1133027165L;
    ...
    public final FitMate.FitMateBackend.workout.entity.QWorkout workout;
    ...
    public QRecommendedWorkout(Class<? extends RecommendedWorkout> type, PathMetadata metadata, PathInits inits) {
        ...
        this.workout = inits.isInitialized("workout") ? new FitMate.FitMateBackend.workout.entity.QWorkout(forProperty("workout")) : null;
