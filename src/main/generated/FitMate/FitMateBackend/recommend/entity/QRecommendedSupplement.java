...
public class QRecommendedSupplement extends EntityPathBase<RecommendedSupplement> {
    ...
    private static final long serialVersionUID = -481905421L;
    ...
    public final FitMate.FitMateBackend.supplement.entity.QSupplement supplement;
    ...
    public QRecommendedSupplement(Class<? extends RecommendedSupplement> type, PathMetadata metadata, PathInits inits) {
        ...
        this.supplement = inits.isInitialized("supplement") ? new FitMate.FitMateBackend.supplement.entity.QSupplement(forProperty("supplement")) : null;
